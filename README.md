...
####  NB!! I have applied Abstraction on the Javascript file(script.js) by inserting higher order functions so that only the relevent functions will be called instead the functionality itself
